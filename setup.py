# -*- coding: utf-8 -*-
"""Generate PostgreSQL partitioned table DDL"""
import os
import re
...
version = ''
with open('pgpart/__init__.py', 'r') as fd:
...
setup(
    name='pgpart',
    version=version,
    url='https://github.com/achiku/pgpart',
    license='MIT',
    author='Akira Chiku',
    author_email='akira.chiku@gmail.com',
    description='Generate PostgreSQL partitioned table DDL',
